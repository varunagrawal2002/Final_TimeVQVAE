...
class Evaluation(object):
    ...
    def log_visual_inspection(self, n_plot_samples: int, X_gen, ylim: tuple = (-5, 5)):
        ...
        plt.tight_layout()
        # output_dir = r"C:/Users/USER/OneDrive/Desktop/NUS_Varun_TimeVQVAE/Results_TSNE"
        # os.makedirs(output_dir, exist_ok=True)
        # plt.savefig(os.path.join(output_dir, "Plot_stairsdown.png"))
    ...
    def log_tsne(self, n_plot_samples: int, X_gen, z_test: np.ndarray, z_gen: np.ndarray):
        ...
        # output_dir = r"C:/Users/USER/OneDrive/Desktop/NUS_Varun_TimeVQVAE/Results_TSNE"
        # os.makedirs(output_dir, exist_ok=True)
        # plt.savefig(os.path.join(output_dir, "TSNE_inclinedown_data.png"))
        ...
        # output_dir = r"C:/Users/USER/OneDrive/Desktop/NUS_Varun_TimeVQVAE/Results_TSNE"
        # os.makedirs(output_dir, exist_ok=True)
        # plt.savefig(os.path.join(output_dir, "TSNE_inclinedown_latent.png"))
